...
public class PreferencesHelper {
	...
	public static boolean hideAppDock = prefs.getBoolean("hideappdock", false);
	...
	public static boolean gestureSwipeUp_AppDock = prefs.getBoolean("gestureswipeupappdock", false);
	public static boolean gestureSwipeUp_AppDrawer = prefs.getBoolean("gestureswipeupappdrawer", false);
	public static boolean gestureSwipeDown_CloseAppDrawer = prefs.getBoolean("gestureswipedowncloseappdrawer", false);
	...
	public static int appDockBackgroundColor = prefs.getInt("appdockbackgroundcolor", Color.argb(0xA5, 0X00, 0x00, 0x00));
